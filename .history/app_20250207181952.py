...
<form>
    ...
    <input type="text" id="name" name="name" class="stTextInput"><br><br>
    <input type="submit" value="Submit" class="custom-button">
</form>
"""
components.html(html_form, height=200)


# sidebar for navigation
with st.sidebar:
    selected = option_menu('Prediction of Disease Outbreaks System',['Diabetes Prediction','Heart Disease Prediction',
                        'Parkinsons Prediction'],menu_icon='hospital-fill',icons=['activity', 'heart', 'person'],default_index=0)
